...
export const BEGINNER_DESC = "Less or no physical activity, mostly occupied with work or studies.";
export const INTERMEDIATE_DESC = "Exercises 3 to 4 times a week, manages to make time for fitness.";
export const ADVANCED_DESC = "Exercises 5 to 6 times a week, highly dedicated towards fitness.";
...
export const ICON_SIZE_EXTRA_LARGE = 30;
